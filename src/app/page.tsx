...
const FLOW = `Your iPhone, iPad, Mac, terminal, or app
             │
             │  sends title + text + optional source URL
             ▼
Your private OneNote System API
             │
...
export default function Home() {
  return <main>
    ...
    <section className="hero">
      ...
      <p className="lead">OneNote System gives Shortcuts, your terminal, Discord, and other apps one private address for creating pages in the OneNote section you choose. You host it yourself, so there is no shared OneNote System account and no stranger&apos;s database holding your credentials.</p>
      ...
      <p className="fine-print">Free and open source · Designed for Vercel or your own server · No subscription to OneNote System</p>
    </section>

    <section className="block" id="how-it-works">
      <p className="eyebrow">The simple version</p>
      <h2>How it works</h2>
      <p className="lede">Microsoft already provides the secure OneNote API. OneNote System connects your own tools to that API without putting a Microsoft password inside a Shortcut.</p>
      ...
      <div className="grid three">
        ...
        <article><span className="card-number">3</span><h3>You capture</h3><p>A Shortcut sends text to your private endpoint. OneNote System immediately creates a real page in your selected OneNote section.</p></article>
      </div>
    </section>
    ...
    <section className="block">
      ...
      <p><Link className="text-link" href="/terminal">Install the terminal client and use OneNote from a shell →</Link></p>
    </section>
    ...
    <section className="block">
      ...
      <ol className="steps">
        <li><h3>Put your own copy on Vercel</h3><p>Vercel is the computer on the internet that keeps your OneNote System URL available even when your phone and home computer are asleep.</p></li>
    ...
    <section className="block">
      ...
      <div className="grid two">
        <article><h3>Your browser</h3><p>The site remembers only your light/dark preference and which setup step you last viewed. It does not place Microsoft tokens, client secrets, API keys, or note text in browser storage.</p></article>
    ...
    <section className="block">
      ...
      <div className="grid two">
        ...
        <article><h3>Do I give this site my Microsoft password?</h3><p>No. You sign in on Microsoft&apos;s page. OneNote System receives revocable access tokens, never your password.</p></article>
        ...
        <article><h3>Is Discord ready?</h3><p>Yes. Setup Step 6 securely saves the Discord application settings, verifies signed interactions, and registers a <code>/onenote</code> command for creating and appending pages.</p></article>
      </div>
    </section>
