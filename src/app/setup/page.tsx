...
export default function SetupPage() {
  return <main>
    ...
    <section className="page-intro">
      ...
      <p className="fine-print">This browser remembers the last numbered step you viewed and your light/dark preference. Secrets and Microsoft tokens are never stored in browser localStorage.</p>
    </section>
    <SetupWizard />
    <SiteFooter />
  </main>;
